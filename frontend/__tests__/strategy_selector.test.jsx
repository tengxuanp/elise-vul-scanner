...
import AssessPage from '../src/app/assess/page';
...
describe('Strategy Selector', () => {
  ...
  beforeEach(() => {
    ...
    const { health } = require('../../src/lib/api');
